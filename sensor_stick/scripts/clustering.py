...
def split_cloud(cloud):
    ...
    table_cloud, objects_cloud = do_ransac_plane_segmentation(
        filtered_cloud, max_distance=0.01)
...
def pcl_callback(pcl_msg):
    ...
    # clusters = get_clusters(colorless_cloud, tolerance=5, min_size=1, max_size=1500)
...
if __name__ == '__main__':
    ...
    # Create Subscribers
    # rospy.Subscriber("/sensor_stick/point_cloud", pc2.PointCloud2, pcl_callback, queue_size=1)
    rospy.Subscriber("/robotis/sensor/assembled_scan", pc2.PointCloud2, pcl_callback, queue_size=1)
