...
class Excel:
    ...
    def create_file(self):
        if not os.path.exists(self.file_path):
            ...
            worksheet.set_column('B:T', 15)   # set column B:T width
            ...
            worksheet.write('N1', 'pose_x',       header_format)
            worksheet.write('O1', 'pose_y',       header_format)
            worksheet.write('P1', 'pose_theta',   header_format)
            worksheet.write('Q1', 'top_frame',    header_format)
            worksheet.write('R1', 'robot_frame',  header_format)
            worksheet.write('S1', 'tripod_frame', header_format)
            worksheet.write('T1', 'rs_frame',     header_format)
